...
export default function createBasketPayInformation(totalPrice: number): HTMLElement {
  ...
  const basketPayInfSubtotalContainer = createElement(basketPayInfSubtotalContainerPapams);
  ...
  const basketPayInfSubtotalDescription = createElement(basketPayInfSubtotalDescriptionPapams);
  ...
  const basketPayInfSubtotalPrice = createElement(basketPayInfSubtotalPricePapams);
  ...
  const basketPayInfTotalContainer = createElement(basketPayInfTotalContainerPapams);
  ...
  const basketPayInfTotalDescription = createElement(basketPayInfTotalDescriptionPapams);
